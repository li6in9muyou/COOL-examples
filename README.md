# This repo contains many COOL programs

Files that ends with `.cl~` contains errors while `.cl` files are valid.

The following is the original content comes with the course.
